...
To demonstrate that anonymization preserves analytical utility, 40+ queries
were written against the four purpose-limited views. These are organized in
`view_queries_sql/` and cover:

- Customer lifetime value, retention, and recency analysis
- Demographic and revenue breakdowns by country, gender, and age range
- Product category and payment method performance
- Regional trends and month-over-month revenue growth

SQL techniques include window functions (`ROW_NUMBER`, `RANK`, `LAG`),
CTEs, conditional aggregation, and date-based calculations.
...
| Analytical queries on anonymized views | 40+ |
| Cloud API calls | 0 |
